...
<div id="athemes-patcher-options-page">
    ...
    <?php if ( defined( 'ATHEMES_AFE_PRO_VERSION' ) && ! defined( 'ATHEMES_PATCHER_VERSION' ) ) : ?>
        <div class="addons-dashboard-alert addons-dashboard-alert-warning addons-dashboard-alert-with-icon addons-dashboard-alert-with-upsell-link">
            ...
            <p class="bt-text-color-grey"><?php echo esc_html__( 'Please note that to use this feature you need to activate the aThemes Patcher plugin.', 'athemes-addons-elementor' ); ?></p>
            <a href="#" class="addons-dashboard-link addons-dashboard-link-succes addons-dashboard-external-link addons-install-plugin" data-type="external" data-plugin-url="https://patcher.athemes.com/athemes-patcher.zip?nocache=<?php echo esc_attr( time() ); ?>" data-plugin-name="athemes-patcher/athemes-patcher.php" data-redirect-to="<?php echo esc_url( add_query_arg('page', 'athemes-patcher-ap', admin_url('admin.php')) ); ?>">
                <?php echo esc_html__( 'Install and Activate aThemes Patcher', 'athemes-addons-elementor' ); ?>
            </a>
        </div>
    <?php endif; ?>
