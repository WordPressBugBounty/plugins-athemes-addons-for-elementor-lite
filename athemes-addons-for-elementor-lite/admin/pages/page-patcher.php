...
<div id="athemes-patcher-options-page">
    <?php if ( ! defined( 'ATHEMES_AFE_PRO_VERSION' ) ) : ?>
        <div class="addons-dashboard-alert addons-dashboard-alert-warning addons-dashboard-alert-with-icon addons-dashboard-alert-with-upsell-link">
            ...
            <p class="bt-text-color-grey"><?php echo esc_html__( 'Please note this feature is available only in aThemes Addons Pro', 'athemes-addons-elementor' ); ?></p>
            <a href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" class="addons-dashboard-external-link" target="_blank">
                <?php echo esc_html__( 'Upgrade Now', 'athemes-addons-elementor' ); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ( defined( 'ATHEMES_AFE_PRO_VERSION' ) && ! defined( 'ATHEMES_PATCHER_VERSION' ) ) : ?>
                                    <a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip addons-install-plugin" href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This will install and activate the aThemes Patcher plugin', 'athemes-addons-elementor' ); ?>" data-type="external" data-plugin-url="https://patcher.athemes.com/athemes-patcher.zip?nocache=<?php echo esc_attr( time() ); ?>" data-plugin-name="athemes-patcher/athemes-patcher.php" data-redirect-to="<?php echo esc_url( add_query_arg('page', 'athemes-patcher-ap', admin_url('admin.php')) ); ?>">
                                        Install Patcher
                                    </a>
                                <?php else : ?>
                                    <a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip" href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This is only available on aThemes Addons Pro', 'athemes-addons-elementor' ); ?>">
                                        Apply
